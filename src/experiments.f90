...
contains
    ...
    subroutine simulate_elm(elm_heat_load, elm_density_change, elm_core_particle_source, time)
        ...
        ! Ouput parameters
        real(wp), intent(out)       :: elm_heat_load, elm_density_change, elm_core_particle_source
	...
	elm_core_particle_source = 0d0
		...
		elm_core_particle_source = elm_core_particle_source + quantity ! used when L_core_SOL .gt. 0d0
                if (isnan(elm_density_change)) then
                    elm_density_change = 0d0
                endif
        	if (isnan(elm_core_particle_source)) then
                    elm_core_particle_source = 0d0
                endif
            endif
